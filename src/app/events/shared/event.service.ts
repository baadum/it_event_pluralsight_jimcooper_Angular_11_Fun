...
// injectable decorator only required when the service injects other services as dependencies
@Injectable()
...
saveEvent(event){
	...
	return this.http.post<IEvent>('/api/events', event, options) // "return" for can subscribe after save
...
// arrays: data arrives over time
// angular's designed to work well with observables and promises
